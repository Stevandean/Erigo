...
const ContainerAdminDashboard: FC = () => {
  ...
  useEffect(() => {
    ...
    getDataTransaction();
    getDataUser();
  }, [getDataCategories, getDataProduct, getDataTransaction, getDataUser]);
    ...
    <AdminLayout>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats
          ...
          total={isLoading ? "-" : dataCategories?.length}
        >
          <svg
        ...
        <CardDataStats
          title="Total Product"
          total={isLoading ? "-" : dataProduct?.length}
        >
          <svg
            className="fill-navy dark:fill-white"
            width="22"
        ...
        <CardDataStats
          ...
          total={isLoading ? "-" : dataTransaction?.length}
        >
          <svg
            className="fill-navy dark:fill-white"
            width="20"
        ...
        <CardDataStats
          title="Total Users"
          total={isLoading ? "-" : dataUser?.length}
        >
          <svg
            className="fill-navy dark:fill-white"
            width="22"
...
export default ContainerAdminDashboard;
